...
with col_results:
    ...
    with c1:
        ...
        <div class="metric-card">
          ...
          <div class="metric-sub" style="margin-top:0.4rem; color:#4a6080;">
            ⏱ inference: {sm_time*1000:.0f}ms
          </div>
        </div>
        """, unsafe_allow_html=True)
    with c2:
        ...
        <div class="metric-card">
          ...
          <div class="metric-sub" style="margin-top:0.4rem; color:#6040a0;">
            ⏱ inference: {hy_time*1000:.0f}ms
          </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div style="display:flex; gap:1.5rem; align-items:center;
      ...
      <div class="mono" style="color:#7a78a8;">
        Δ confidence: <span style="color:#e8e6ff">{delta:.2f}%</span>
      </div>
      <div class="mono" style="color:#7a78a8;">
        PnP heads: <span style="color:#b8a8ff">{pnp_heads}/144</span>
        &nbsp;({pnp_pct:.1f}%)
      </div>
      <div class="mono" style="color:#7a78a8;">
        🔵 softmax: <span style="color:#6090c0">{sm_time*1000:.0f}ms</span>
      </div>
      <div class="mono" style="color:#7a78a8;">
        🟣 hybrid: <span style="color:#b8a8ff">{hy_time*1000:.0f}ms</span>
      </div>
      <div class="mono" style="color:#7a78a8;">
        speedup: <span style="color:#e8e6ff">{'%.2fx' % (sm_time/hy_time) if hy_time > 0 else 'N/A'}</span>
      </div>
    </div>
    """, unsafe_allow_html=True)
