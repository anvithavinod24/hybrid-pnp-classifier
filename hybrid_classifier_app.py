...
class OGAttentionWithHook(nn.Module):
    def __init__(self, old_attn):
        ...
        # deep copy weights so there's zero shared state with any other model
        import copy
    ...
    def forward(self, x, attn_mask=None):
        ...
        # no dropout — we're always in eval mode and want clean attention probs
...
with col_results:
    ...
    mem_before_sm = _proc.memory_info().rss / 1024 / 1024
    ...
    sm_peak_mem_mb = _proc.memory_info().rss / 1024 / 1024 - mem_before_sm
    ...
    mem_before_hy = _proc.memory_info().rss / 1024 / 1024
    ...
    hy_peak_mem_mb = _proc.memory_info().rss / 1024 / 1024 - mem_before_hy
